/**
 * AC-4: Active session — session detail page renders with terminal component.
 *
 * Verifies that the session detail page renders the terminal panel
 * and metadata sidebar for an active session.
 */
...
describe("AC-4: Session detail page renders with terminal component", () => {
  it("renders the terminal panel with toolbar", async () => {
    render(
      <TerminalPanel
  ...
  it("renders terminal container for xterm", async () => {
    render(
      <TerminalPanel
        agentHost="100.64.0.1:7400"
        sessionId="sess-active-1"
  ...
  it("connects WebSocket to the correct agent", async () => {
    render(
      <TerminalPanel
        agentHost="100.64.0.1:7400"
        sessionId="sess-active-1"
    ...
    expect(ws.url).toBe("ws://100.64.0.1:7400/sessions/sess-active-1/stream");
  });
