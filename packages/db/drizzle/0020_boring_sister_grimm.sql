...
CREATE UNIQUE INDEX "elevenlabs_credentials_agent_id_unique" ON "elevenlabs_credentials" USING btree ("agent_id");--> statement-breakpoint
CREATE INDEX "elevenlabs_credentials_agent_id_idx" ON "elevenlabs_credentials" USING btree ("agent_id");