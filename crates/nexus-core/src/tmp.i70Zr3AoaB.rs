...
pub enum LifecycleEventKind {
    ...
    SpecComplete { spec_name: String, tasks_total: u32 },
...
///
/// Looks for a component following "dev" in the path (typical layout: ~/dev/<code>).
/// Falls back to the last path component if it looks like a short project code,
/// or returns an empty string if nothing matches.
...
mod tests {
    ...
    fn test_session_start_constructor() {
        ...
        assert!(matches!(ev.kind, LifecycleEventKind::SessionStart { .. }));
    }
