...
Let a phone (or any Tailnet client) drop pasted file bytes into a project directory
on a dev machine via the nexus-agent, without SSH/scp — the "Raycast paste -> pick
project -> land in docs/screenshots" flow, agent-native.
