...
- [ ] [3.1] [P-1] Create warning banner component for agent-unreachable state with failed agent list [owner:ui-engineer] [beads:nx-2flp]
- [ ] [3.2] [P-1] Update credential page to branch on `agentReachable`: show banner (false) vs table/empty (true) [owner:ui-engineer] [beads:nx-lzud]
