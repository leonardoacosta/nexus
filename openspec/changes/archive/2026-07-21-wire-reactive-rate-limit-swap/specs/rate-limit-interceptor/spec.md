# rate-limit-interceptor — Delta

## RENAMED Requirements
- FROM: `### Requirement: The system SHALL swap credentials via atomic symlink`
- TO: `### Requirement: The system SHALL swap the active credential via the pool manual-swap primitive`
