...
- [x] [3.2] Update `openspec/specs/test-infrastructure/spec.md` post-archive with the new gate-enforced field guarantees [handled by Phase 4 archive] [owner:devops-engineer] [type:docs] [beads:nx-njlkz]
