...
- [ ] [4.4] E2E: a `cc_profile_events` row (renamed from `credential_events`) is populated after both lease and release (nx-b0ew) [owner:e2e-engineer] [type:testing] [beads:nx-owo7j]
